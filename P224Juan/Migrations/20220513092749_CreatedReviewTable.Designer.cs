...
namespace P224Juan.Migrations
{
    ...
    [Migration("20220513092749_CreatedReviewTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P224Juan.Models.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P224Juan.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P224Juan.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P224Juan.Models.OrderItem", b =>
                {
                    b.HasOne("P224Juan.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("P224Juan.Models.Review", b =>
                {
                    ...
                    b.HasOne("P224Juan.Models.Product", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ProductId");
                });
